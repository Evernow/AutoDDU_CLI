    ...
    for adapter in network_adapters:
       try:
        if enable == False:
            ...
            logger("Got this when checking if for else in internet function: " + str((adapter.Name in obtainsetting("disabledadapters"))))
